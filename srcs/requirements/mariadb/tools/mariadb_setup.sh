...
# mysql -e "ALTER USER 'root'@'%' IDENTIFIED BY '$WP_ADMIN_PWD'";
...
mysql -e "UPDATE mysql.user SET plugin = 'mysql_native_'";
mysql -e "SET PASSWORD FOR 'root'@'localhost' = PASSWORD('$WP_ADMIN_PWD')";
